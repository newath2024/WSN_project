...
namespace Picturebox
{
    ...
    public partial class FrmCB2 : Form
    {
        ...
        double a;
        int b;
        private void FrmCB2_Load(object sender, EventArgs e)
        {
        ...
        private async void HienThiNhietDo()
        {
            ...
            txtNhietDo.Text = obj.NhietDoCB2;
        }
        ...
        private void txtNhietDo_TextChanged_1(object sender, EventArgs e)
        {
